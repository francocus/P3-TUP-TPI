  ...
  return (
    <article className={`cases-item ${expanded ? 'is-expanded' : ''}`}>
      ...
      >
        ...
        <svg className="cases-item__chevron" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        ...
        <div className="cases-item__content">
          ...
          <div className="cases-item__section">
            ...
            <div className="cases-item__meta">
              ...
              <span><b>Abogado</b> {lawyerName}</span>
              <span><b>Área</b> {area}</span>
            </div>
          </div>
          ...
          <div className="cases-item__section">
            ...
            <div className="cases-item__meta">
              <span><b>Inicio</b> {startDate}</span>
              <span><b>Actualizado</b> {lastUpdate}</span>
            </div>
          </div>
