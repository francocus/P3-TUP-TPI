...
import { addDays, DAY_NAMES, formatMonthTitle, getDateKey, getSunday, MONTH_NAMES, pad, parseDate, SLOTS } from "../data/appointments.data";
...
const NewAppointment = ({ show, onHide, onSubmit, lawyers, user, token, appointments = [], appointment }) => {
    ...
    >
      ...
      >
        <div>
          ...
          <Modal.Title>
            {isEdit ? "Modificar turno" : "Solicitar turno"}
          </Modal.Title>
        </div>
      </Modal.Header>
